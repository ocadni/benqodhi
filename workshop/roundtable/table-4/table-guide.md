...
standard classical, AI-based, hybrid and quantum. Its role is to define how these
approaches should be compared on candidate problems, and to identify a practical
route for getting BENQODHI benchmark material online and keeping it credible over
time.

## Questions to answer

1. **Comparing approaches** — How should standard classical, AI-based, hybrid and
